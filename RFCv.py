...
rf = RandomForestClassifier(labelCol="EventCode_indexer", featuresCol="features")
...
pipeline = Pipeline(stages=[Actor1_indexer, Actor2Code_indexer, Actor1Country_indexer, Actor2Country_indexer,
                            ...
                            Actor2Country_encoder,EventCode_indexer, Region_encoder, assembler, rf])
...
result.show()
print('A Random Forest algorithm had an accuracy of: {0:2.2f}%'.format(pp_Acc*100))
